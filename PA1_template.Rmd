...
Once the table is grouped, we can generate an histogram using the base ploting system:

```{r}
hist(tablaporfecha$Total_steps, xlab = "Total steps", main = "Histogram of the total number of steps taken each day")
```
